...
│  (Raw Events)   │     │   (raw_events)  │     │ (silver_events) │
└─────────────────┘     └─────────────────┘     └─────────────────┘
                                                         │
                        ┌────────────────────────────────┼────────────────────────────────┐
                        ▼                                ▼                                ▼
               ...
               │   (Map Data)    │              │  (Time Series)  │              │   (By Region)   │
               └─────────────────┘              └─────────────────┘              └─────────────────┘
                        │
                        ▼
               ┌─────────────────┐              ┌─────────────────┐
               │ Databricks App  │              │  AI/BI Genie    │
               │  (Streamlit)    │              │    Space        │
               └─────────────────┘              └─────────────────┘
```
...
Update the environment variables in `streamlit_app/app.yaml`:
...
| Setting | Description |
|---------|-------------|
| **DATABRICKS_WAREHOUSE_ID** | SQL Warehouse ID - find in SQL Warehouses → your warehouse → Connection Details |
| **CATALOG** | Unity Catalog name (e.g., `quake_lake`) |
| **SCHEMA** | Schema name (e.g., `usgs_earthquakes`) |
...
#### Streamlit App (configured in `streamlit_app/app.yaml`)
